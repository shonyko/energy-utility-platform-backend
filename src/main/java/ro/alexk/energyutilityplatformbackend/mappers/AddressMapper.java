...
public abstract class AddressMapper implements BaseMapper<Address, AddressCreateDto, AddressDto, AddressUpdateDto> {
    ...
    public abstract Address map(AddressUpdateDto from, @Context UpdateContext context);
}
